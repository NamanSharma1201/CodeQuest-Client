...
const GlobalChat = ({ onClose }) => {
    return (
        ...
        >
            ...
            <Box sx={{ flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', p: 2 }}>
                <LockIcon sx={{ fontSize: 60, color: '#ffc107' }} />
                <Typography variant="h6" sx={{ mb: 2, textAlign: 'center', color: '#212529' }}>
                    The Global Chat is currently unavailable.
                </Typography>
                <Typography variant="body2" sx={{ textAlign: 'center', color: '#212529' }}>
